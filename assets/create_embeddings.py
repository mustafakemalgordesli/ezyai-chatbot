...
# results = vector_store.similarity_search_with_score("beyaz spor ayakkabı", k=1, filter=price_filter)

# for res, score in results:
#     print(f"*[SIM={score:3f}]")
#     print(res.metadata.get("id"), res.metadata.get("price"), res.metadata.get("vote"))
